...
global GRAPH_SIG_ACC_CONTOURS GRAPH_EMT_CONTOURS 
...
GRAPH_HPL_CONTOURS   = [0 20 40 60 80 100 185 370 556];
...
GRAPH_SIG_ACC_CONTOURS   = linspace(0,1.87,9);
GRAPH_EMT_CONTOURS       = linspace(1,15,9);
